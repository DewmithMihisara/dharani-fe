...
import { uploadBadge } from '../api/retailBadgeApi'
...
export default function RetailBadgeUploadDialog({ onClose, onUploaded }) {
  ...
  async function handleUpload() {
    ...
    try {
      const res = await uploadBadge({ items }, token)
      if (res.status === 200) {
        ...
        <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden">
          ...
          <div className="bg-[#14213d] px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-white font-semibold text-sm">Upload Retail Badge by Excel</span>
            </div>
