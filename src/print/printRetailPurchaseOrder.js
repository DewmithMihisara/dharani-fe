...
export async function printRetailPurchaseOrder(orderId, token = null) {
  const poRes = await apiPatch('/retail-orders/' + orderId + '/print-po', null, token)
...
<div class="doc-title">
  P U R C H A S E &nbsp; O R D E R &nbsp; (R E T A I L)
...
<div class="info-grid">
  <div class="info-box">
    ...
    <div class="cr"><span>Mobile No.</span><span>:</span><span class="cv">${o.mobileNumber1 || ''}</span></div>
    <div class="cr"><span>Mobile No. 2</span><span>:</span><span class="cv">${o.mobileNumber2 || ''}</span></div>
