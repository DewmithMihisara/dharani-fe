...
export async function printRetailBalanceDue(orderId, token = null) {
  ...
  const advancePaid = Number(o.advancePayment?.advanceAmount || 0)
  const balancePaid = Math.max(0, total - advancePaid)
...
<div class="doc-title">B &nbsp; A &nbsp; L &nbsp; A &nbsp; N &nbsp; C &nbsp; E &nbsp;&nbsp; P &nbsp; A &nbsp; I &nbsp; D</div>
...
<table class="items">
  ...
  <tfoot>
    ...
    <tr class="balance-row">
      <td colspan="3" class="r">Balance Paid :</td>
      <td class="r">LKR&nbsp;${fmt(balancePaid)}</td>
    </tr>
  </tfoot>
</table>
